                    ...
                    firstProjectStep={
                        <ProjectSection topic="Research & Interviews" >
                                ...
                                <Grid container 
                                    ...
                                    justifyContent="center"
                                    alignItems="center">
                                    <Grid item sm={6} md={6} lg={3} textAlign="center">
                                        <img width='200' style={{borderRadius: '2px'}} src={PrintScreenOldApp1}></img>
                                    </Grid>
                                     <Grid item sm={6} md={6} lg={3} textAlign="center">
                                        <img width='200' style={{borderRadius: '2px'}} src={PrintScreenOldApp4}></img>
                                    </Grid>
                                    <Grid item sm={6} md={6} lg={3} textAlign="center">
                                        <img width='200' style={{borderRadius: '2px'}} src={PrintScreenOldApp3}></img>
                                    </Grid>
                                    <Grid item sm={6} md={6} lg={3} textAlign="center">
                                        <img width='200' style={{borderRadius: '2px'}} src={PrintScreenOldApp2}></img>
                                    </Grid>
                                </Grid>

                                <Typography variant="caption" component='p' pb={2} pt={1} textAlign='center' >Print screens of the Lung Function Module and main menu of InspirerKids</Typography>
                                ...
                                <Typography variant="emphasisRegularText" component='p'>
                                    At this stage, <Typography variant="emphasisRegularText" component='span' sx={{color: 'rgb(174 187 255)', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>teens begin to seek more independence and responsibility</Typography>, allowing me to create a <Typography variant="emphasisRegularText" component='span' sx={{color: 'rgb(174 187 255)', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>positive experience without relying heavily on parents or caregivers.</Typography>
                                </Typography>
                                ...
                                <Box sx={{textAlign: 'center', display: {xs: 'none', sm: 'block', md: 'block'}}}>
                                    <iframe loading="lazy" width="550" height="315" src="https://www.youtube.com/embed/FV-Rb_LJ1j4?si=t9gOP1nkFKihoXlD&amp;controls=0&amp;start=37" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                    <Typography variant="caption" component='p' pb={2} pt={1} textAlign='center'>Forced Expiratory Maneuver in the context of spirometry</Typography>
                                </Box> 
                            ...
                            <Typography variant="stepTitleHeader" pt={4}>Interview Guide & User Persona</Typography>
                            <Typography variant="pRegularText" component='p'>
                            ...
                            <Typography variant="emphasisRegularText" component='p'>I conducted <Typography variant="emphasisRegularText" component='span' sx={{color: 'rgb(174 187 255)', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>semi-structured interviews</Typography> using: a <Typography variant="emphasisRegularText" component='span' sx={{color: 'rgb(174 187 255)', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>thematic question guide and mind maps</Typography>; obtained <Typography variant="emphasisRegularText" component='span' sx={{color: 'rgb(174 187 255)', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>recording permissions and participant consent</Typography>; and planned to start with easy questions while maintaining a compassionate approach.</Typography>
                    ...
                    secondProjectStep={
                        <ProjectSection topic="Concept">
                            ...
                            <Typography variant="emphasisRegularText" component='p'>
                            To understand the current preferences of Portuguese teenagers, I <Typography variant="emphasisRegularText" component='span' sx={{color: '#E2B921', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>conducted both literary and online research</Typography>. Additionally, I held <Typography variant="emphasisRegularText" component='span' sx={{color: '#E2B921', [theme.breakpoints.up('md')]: {
          padding: 0
        }}}>in-person meetings and phone calls to create mood boards</Typography> that explored their interests, such as games, TV shows, colors, and fashion.
                            </Typography>
                            <Typography variant="pRegularText" component='p' pb={0}>
...
After gathering positive feedback from small casual tests, I felt confident enough to proceed with the development of the high-fidelity prototype and the design system.
                            ...
                            <Stack direction='column' textAlign={'center'} sx={{
                                ...
                                <Stack spacing={3} direction='row' justifyContent='center' alignItems={'center'} textAlign={'center'} sx={{paddingTop: '64px'}}>
                                    <img height={136} width={113} src={Madalena} />                                                                  
                                    <Button variant="outlined"
                                        sx={{
                                            width: 260,
                    ...
                    fifthProjectStep={
                        <ProjectSection backgroundColor="#0B1231" topic="Evaluation">
                            ...
                            <Typography variant="stepTitleHeader" pt={4}>Executive Summary</Typography>
                            <Box sx={{padding: '32px 0', maxWidth: '77ch'}}>
                            ...
                            <Typography variant="stepTitleHeader" pt={4}>Method</Typography>
                            <Box sx={{padding: '32px 0', maxWidth: '77ch'}}>
                                <Accordion sx={{bgcolor: "#1a2241", color: "#fff" }}>
                                    <AccordionSummary
                                    expandIcon={<ExpandMoreIcon sx={{color: "#fff"}}/>}
                            ...
                            <Typography pt={4} variant="stepTitleHeader" display='block' fontWeight={700}>
                                User Profiles                            
                            </Typography>
                ...
                />
                            ...
                            <Typography variant="stepTitleHeader" display='block' fontWeight={700} pt={4}>
                                Human Results                            
                            </Typography>
            ...
            <Typography variant="stepTitleHeader" pt={4}>Findings and recommendations</Typography>
            <Box sx={{padding: '32px 0 0 0', maxWidth: '77ch'}}>
                <Accordion sx={{bgcolor: "#1a2241", color: "#fff" }}>
                    <AccordionSummary
                    expandIcon={<ExpandMoreIcon sx={{color: "#fff"}}/>}
                    aria-controls="panel3-content" 
