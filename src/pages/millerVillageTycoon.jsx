...
const MillerVillageTycoonPage = () => {
    ...
    padding: 0
} */}}>teens begin to seek more independence and responsibility</Typography>, allowing me to create a <Typography variant="emphasisRegularText" component='span' sx={{color: 'rgb(174 187 255)'/* , [breakpoints.up('md')]: {
    padding: 0
